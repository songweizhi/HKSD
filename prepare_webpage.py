...
# file in
web_page_file_template  = 'doc/page_template_with_barchart.html'
sample_metadata_txt     = 'doc/sample_data.txt'

# file out
web_page_file_out       = 'HKSD_single_page_with_barchart.html'


'''
cd '/Users/songweizhi/Library/Mobile Documents/com~apple~CloudDocs/Funding/2025_4-ECF_R&D/HKSD_website'
python3 /Users/songweizhi/PycharmProjects/HKSD/prepare_webpage.py
'''
...
for each_line in open(sample_metadata_txt):
    ...
    if line_num_index == 1:
        ...
        photo_attribute_str = '      {accession: "%s", photo: "%s", taxon: "%s", loci: "%s", loci_eng: "%s", loci_chi: "%s", lat: %s, lng: %s, desc: "%s", coord: "%s", source: "%s"},' % (sample_accession, sample_image, sample_taxon, sample_location, sample_location_eng, sample_location_chi, sample_latitude, sample_longitude, sample_desc, sample_coord, sample_source)
